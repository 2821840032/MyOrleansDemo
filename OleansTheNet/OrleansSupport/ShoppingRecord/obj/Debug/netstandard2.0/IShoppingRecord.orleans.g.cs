...
[assembly: global::Orleans.Metadata.FeaturePopulatorAttribute(typeof(OrleansGeneratedCode.OrleansCodeGen516c61e984FeaturePopulator))]
...
namespace IShoppingRecord
{
    ...
    internal class OrleansCodeGenShoppingRecordReference : global::Orleans.Runtime.GrainReference, global::IShoppingRecord.IShoppingRecord
    {
        ...
        public global::System.Threading.Tasks.Task<global::Entity.OrderEntity> GetOrderDescribe(global::System.Int32 orderID)
        {
            return base.InvokeMethodAsync<global::Entity.OrderEntity>(913561875, new global::System.Object[]{orderID});
        }
    }
        ...
        public async global::System.Threading.Tasks.Task<global::System.Object> Invoke(global::Orleans.Runtime.IAddressable grain, global::Orleans.CodeGeneration.InvokeMethodRequest request)
        {
            ...
            switch (interfaceId)
            {
                case -1726117617:
                    ...
                    {
                        case 913561875:
                            return await ((global::IShoppingRecord.IShoppingRecord)grain).GetOrderDescribe((global::System.Int32)arguments[0]);
                        default:
                            throw new global::System.NotImplementedException(@"interfaceId=" + -1726117617 + @",methodId=" + methodId);
                    }
...
namespace OrleansGeneratedCodeBCE31A2D
{
    using global::Orleans;
    using global::System.Reflection;
}

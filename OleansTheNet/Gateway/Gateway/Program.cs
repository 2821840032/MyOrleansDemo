        ...
        static async Task<ISiloHost> StartHost()
        {
            var builder = new SiloHostBuilder()
                 ...
                 //})
                    ...
                    .Configure<SerializationProviderOptions>(d => { d.SerializationProviders.Add(typeof(BondSerializer).GetTypeInfo()); d.FallbackSerializationProvider = typeof(BondSerializer).GetTypeInfo(); })
